 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__EED47FB5_458A7C_4544F3_45A786_45563FD2DAF015;
...
@Path("/TransactionMonitoringDMN")
public class TransactionMonitoringDMNResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_EED47FB5-8A7C-44F3-A786-563FD2DAF015", "TransactionMonitoringDMN");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_EED47FB5-8A7C-44F3-A786-563FD2DAF015", "TransactionMonitoringDMN", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("TransactionMonitoringDMN") + ".dmn_nologic")));
    }
