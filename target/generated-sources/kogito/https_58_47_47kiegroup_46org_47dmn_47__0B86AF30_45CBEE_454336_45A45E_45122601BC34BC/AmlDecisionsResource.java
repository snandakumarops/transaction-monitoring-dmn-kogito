 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__0B86AF30_45CBEE_454336_45A45E_45122601BC34BC;
...
@Path("/AmlDecisions")
public class AmlDecisionsResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("AmlDecisions") + ".dmn_nologic")));
    }
    ...
    @POST
    @Path("/Aml Alert Service")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDS11")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSetDS11")), description = "DMN output")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDS11")), description = "DMN input")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSetDS11")), description = "DMN output")
    public Response decisionService__Aml_32Alert_32Service(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateDecisionService(DMNJSONUtils.ctx(decision, variables, "Aml Alert Service"), "Aml Alert Service");
        enrichResponseHeaders(decisionResult);
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions", decisionResult);
    ...
    @POST
    @Path("/Aml Alert Service/dmnresult")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDS11")), description = "DMN input")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDS11")), description = "DMN input")
    public Response decisionService__Aml_32Alert_32Service_dmnresult(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateDecisionService(DMNJSONUtils.ctx(decision, variables, "Aml Alert Service"), "Aml Alert Service");
        enrichResponseHeaders(decisionResult);
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_0B86AF30-CBEE-4336-A45E-122601BC34BC", "AmlDecisions", decisionResult);
